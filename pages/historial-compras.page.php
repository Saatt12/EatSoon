...
<style>
    body {
        background-image: url("<?= RUTA ?>/assets/img/fondo ave.jpeg");
    }
</style>
...
<main>
    <div style="background-image: url('<?= RUTA ?>/assets/img/fondo tabla.jpeg');background-size: cover;background-position: center;background-repeat: no-repeat;width: 100%;">
        <div class="container ">
            <div class="row ">
                <h1 class="mb-5 mt-5 text-white">Historial</h1>
                <div style="height: 800px;overflow: auto;">
                <?php if (count($pedidos)==0) {?>
                    <div class="alert alert-danger text-center" role="alert">Usted no tiene productos comprados</div>
                <?php }?>
                    <?php $i = 1; ?>
                                        ...
                                        <div class="row justify-content-center text-white">
                                            ...
                                            <div class="col-5">
                                                <div class="row justify-content-center">
                                                    <div class="col-8">
                                                        <div>
                                                            <h5>Compra #<?php echo ($pedido['codPedido']); ?></h5>
                                                        </div>
                                                        <div>
                                                            <h5>Usuario:<?php echo ($pedido['usuario_CI']); ?></h5>
                                                        </div>
                                                        ...
                                                        <?php if ($pedido['estado'] == "comprado") {
                                                        ?>
                                                            <img src="<?= RUTA ?>/assets/img/jbien verde .jpeg" alt="" width="100">
                                                        <?php } ?>
                                                    </div>
                                                </div>
                                            </div>
