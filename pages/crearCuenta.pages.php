        ...
        <div class="row no-gutters bg-dark">
            ...
            <div class="col-xl-7 col-lg-12 d-flex register-bg" >
                ...
                <div class="container align-self-center p-6">
                    ...
                    <form id = "registrarCuenta" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" class="form-horizontal" style="margin:0 auto" >                        
                     ...
                     <table class="formularioTabla">
                        ...
                        <tr>
                            <td><i class="bi bi-key"  ></i> &nbsp Confirmar contraseña:<span class="text-danger">*</span></td>
